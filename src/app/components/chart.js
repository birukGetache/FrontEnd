    ...
    const fetchData = async () => {
      try {
        const [bookingsResponse, boatOwnersResponse, sponsorsResponse, blogsResponse, usersResponse] =
          await Promise.all([
            axios.get("https://tankwaaddis.onrender.com/booking"),
            axios.get("https://tankwaaddis.onrender.com/boatowners"),
            axios.get("https://tankwaaddis.onrender.com/sponser"),
            axios.get("https://tankwaaddis.onrender.com/api/blogs"),
           // axios.get("https://tankwaaddis.onrender.com/users"),
          ]);
